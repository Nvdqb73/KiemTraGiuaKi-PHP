	...
	<div class="container">
		...
		<form method="POST" action="process_insert.php">
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="formGroupExampleInput" placeholder="employee_code" name="employee_code">
			</div>
			<div class="mb-3">
				<label for="formGroupExampleInput2" class="form-label">Tên nhân viên</label>
				<input type="text" class="form-control" id="formGroupExampleInput2" placeholder="employee_name" name="employee_name">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Nơi sinh" name="Nơi sinh">
			</div>
